...
<script src="{{ asset('lte/bower_components/Flot/jquery.flot.js') }}"></script>
<script src="{{ asset('lte/bower_components/Flot/jquery.flot.resize.js') }}"></script>
<script src="{{ asset('lte/bower_components/Flot/jquery.flot.pie.js') }}"></script>
<script src="{{ asset('lte/bower_components/Flot/jquery.flot.categories.js') }}"></script>
