...
<head>
  ...
  <link href="{{ asset('lte/bower_components/bootstrap-daterangepicker/daterangepicker.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/plugins/iCheck/all.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/plugins/timepicker/bootstrap-timepicker.min.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/bower_components/select2/dist/css/select2.min.css') }} " rel="stylesheet"/>
