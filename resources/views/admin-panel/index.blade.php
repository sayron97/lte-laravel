...
<head>
  ...
  <link href="{{ asset('lte/bower_components/morris.js/morris.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/bower_components/jvectormap/jquery-jvectormap.css') }} " rel="stylesheet"/>
  ...
  <link href="{{ asset('lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/') }} " rel="stylesheet"/>
