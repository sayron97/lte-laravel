...
<head>
  ...
  <link href="{{ asset('lte/bower_components/fullcalendar/dist/fullcalendar.min.css') }} " rel="stylesheet"/>
  <link href="{{ asset('lte/bower_components/fullcalendar/dist/fullcalendar.print.min.css') }} " rel="stylesheet"/>
...
<script src="{{ asset('lte/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('lte/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script>
  $(function () {
